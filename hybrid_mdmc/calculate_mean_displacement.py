...
from hybrid_mdmc.filehandlers import frame_generator, hkmcmd_ArgumentParser, parse_data_file, FileTracker
...
def assemble_molecular_cog(
    ...
    molecular_cog = {}
    for atoms_list_thisframe, timestep_thisframe, box_thisframe, _ in frame_generator(
        filename_trajectory,
        start=start,
        end=end,
        every=every,
...
def write_msd_file(
    ...
    output_file = FileTracker(filename, overwrite=overwrite)

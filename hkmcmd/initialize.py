...
from hkmcmd import utility, interactions, io, system
...
def main(argv):
    ...
    molecules_list = interactions.update_molecules_list_IDs(molecules_list, reset_atom_IDs=True)
    ...
    # Assemble the system
    atoms_list, bonds_list, angles_list, dihedrals_list, impropers_list = interactions.get_interactions_lists_from_molcules_list(molecules_list)
    box = [[-box_length / 2, box_length / 2]]*3

    # Initialize the system state file
    system_state = system.SystemState(

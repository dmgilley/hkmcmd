...
from hkmcmd.io import parse_data_file
from hkmcmd.MSD import assemble_molecular_cog, calculate_msd
...
class TestSystemState(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Read system data
        system_data = system.SystemData("msd_fiction", "msd_fiction", filename_json="msd_fiction.json")
        ...
        system_state = system.SystemState(filename="msd_fiction.system_state.json")
